...
4. generate a personalized runtime skill named project-learning-assistant,
5. write the generated runtime skill to:
   generated-skills/project-learning-assistant/
6. ensure the generated runtime skill behaves like a proactive project-learning copilot rather than passive Q&A,
7. ensure every runtime response requires these sections in order:
   project map
