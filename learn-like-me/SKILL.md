...
5. Use `references/output-templates.md` for the learning profile, generated skill output, and response contract.
6. Use `references/history-drop-template.md` when the user wants a repeatable folder convention for teams or repeated runs.
7. Check `references/examples.md` when you need contrasting patterns for beginner, intermediate, and advanced learners.
